...
- [x] • C01 remediation path chosen + resolved: owner chose (a) → D06 Dixon-Coles retry also failed → D07 raw-Elo headline fallback (2026-06-12)
- [x] • Headline numbers (champion odds) independently recomputed: separate-code simulator agrees within 0.43pp (A, 2026-06-12)
- [x] • Claim statuses signed: C02/C03/C04 → supported (H, Adir 2026-06-12)

## Build & deliver (platform)
- [x] MODEL.md model card written from the spec + findings (A, 2026-06-12)
- [x] GitHub Actions pipeline: scheduled fetch → model update → commit JSON (A, 2026-06-12 — .github/workflows/update.yml)
- [x] Three.js frontend: 3D probability skyline, champion odds, near-live matches, group tables, scorers (B, 2026-06-12)
- [x] Attribution: data sources credited in footer + About section (openfootball PD, martj42 CC0) (A, 2026-06-12)
- [ ] Deployed to free host (GitHub Pages / Cloudflare Pages) (B)
- [~] • Mechanical audit: pipeline regenerates clean (26 fresh/0 stale/0 drift); full trace+map verify pass still owed (A)
- [ ] • Referee run in a fresh session on MODEL.md + pipeline (B)
- [x] • Site inspected visually in preview (B, 2026-06-12 — screenshots: skyline + odds/matches render correctly)
- [ ] • Commit pending site-build changes (D06/D07 outputs, MODEL.md, frontend tweaks) (A)
